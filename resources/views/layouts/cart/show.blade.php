                ...
                <div class="cart-content">
                                ...
                                <div class="right">
                                    <form action="#">
                                        <div class="quantity">
                                            ...
                                            <input type="text" class="quantity" value="{{ $cartDetail->quantity}}"  max="{{ $cartDetail->productStore->quantity_stock }}">
                    ...
                    @if (count($cart->cartDetails)>0)
                        <div class="actions">
                            ...
                            <a href="{{ route('carts.get.order.info',['cart'=>$cart->id]) }}" class="order">Order</a>
                        </div>
                    @else
